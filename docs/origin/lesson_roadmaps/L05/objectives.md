...
- <!-- *NEED INPUT*: is "describing side effects in the tool description" enough, or should L05 also introduce a notion of *typed* side effects (read vs. write vs. external) that the runtime can reason about? The latter foreshadows L15 (human-in-the-loop approval gates), so a forward link may suffice. -->
