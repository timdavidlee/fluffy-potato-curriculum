...
**In the mini cut, L22 is the final lesson and serves as a capstone:** it reframes everything students built — tools (L07/L08), prompts (L02), the agent loop (L10) and its LangGraph form (L03/L11) — around the single question *"where should a capability live, and when should it be in context?"* A good closing exercise has students take a capability they added to their L11 agent and decide (and justify) whether it belongs as a tool, a skill, or system-prompt content.
