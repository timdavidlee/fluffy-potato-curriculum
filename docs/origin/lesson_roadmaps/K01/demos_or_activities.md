# K01: Self-paced walkthrough — Environment & tooling

> Sibling docs: [objectives.md](objectives.md) (what this unit aims for), parent design
> [CURRICULUM_PRD.md](../../CURRICULUM_PRD.md).
>
> **Audience for this file:** the *student*, working alone at a keyboard. Unlike an `L<NN>`
> lesson's teacher-led demos, every step here is something **you run yourself**. There is no
> separate lab — this walkthrough is the hands-on work.

## How to read this file

The unit is a single ordered sequence. Each **Step** has:
...
**WSL2** and follow the Linux path — see the open question in objectives.md).
...
```sh
git clone <REPO_URL>            # <need input: the canonical clone URL / access path>
...
credentials — see the access note in [objectives.md](objectives.md).
