...
> **Lesson:** L20 — Skills: just-in-time capabilities for agents.
> **Roadmap:** see this lesson's [objectives.md](../../../../docs/origin/lesson_roadmaps/L20/objectives.md)
> and [demos_or_activities.md](../../../../docs/origin/lesson_roadmaps/L20/demos_or_activities.md).
...
> lecture ([L2005_lecture.md](L2005_lecture.md)). Hands-on practice is in the L20 labs
> (L2004, L2006).
...
they are, how they're wired, and what they cost ([L04](../L04/L0401_intro.md),
[L05](../L05/L0501_intro.md)); the hand-rolled model → tool → model loop
([L07](../L07/L0701_intro.md)); and that same loop drawn as a LangGraph graph
([L11](../L11/L1101_intro.md), [L12](../L12/L1201_intro.md)).

All of that shares one nagging, unsolved problem: **everything the agent might need has to sit in
the context window all the time.** Every tool's schema is re-sent on every request (L04's "tools
...
This lesson follows the course's spine — **hand-roll it, then meet the product** — exactly like L08
(you built a trace before Langfuse) and L12 (you built the loop before LangGraph):
