...
> **Lesson:** L20. **Roadmap:** [objectives.md](../../../../docs/origin/lesson_roadmaps/L20/objectives.md).
...
- After L04, L05, L07 and L12 you have a working agent — and one unsolved cost problem.
- Every **tool schema** is re-sent on *every* request (L04: "tools cost tokens, twice over").
...
### slide 2.3 Where MCP fits (a one-line aside — full treatment is L06)
...
- We name it and move on; the full treatment is **L06 (MCP), full course**. In the mini cut we
...
- This is L04's "tools cost tokens twice over" problem, directly attacked. You'll read the real token
...
- The **description is a design artifact**, not a label — the skill analogue of L05's tool
